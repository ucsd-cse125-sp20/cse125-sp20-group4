#include "ObjectClasses/Factories/spawnpointfactory.h"
#include "ObjectClasses/spawnpoint.h"
#include "deserializer.h"
#include "logger.h"

std::shared_ptr<Object> SpawnPointFactory::create(std::string serial) { //TODO:Make more robust to serialization errors
    auto log = getLogger("SpawnPointFactory");
    ...
    std::shared_ptr<SpawnPoint> shelf = std::make_shared<SpawnPoint>(id, posx, posy, posz, orx, ory, orz, length, width, height);
    return shelf;

}

std::shared_ptr<Object> SpawnPointFactory::create() {
    return std::make_shared<SpawnPoint>();
}